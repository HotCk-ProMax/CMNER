    ...
    def __init__(self, corpus=None, emb_size=256, jemb_drop_out=0.1, bert_model='bert-base-uncased', \
     coordmap=True, leaky=False, dataset=None, light=False):
        ...
        if bert_model=='bert-base-uncased':
            ...
            self.textdim=1024
        ## Visual model
        self.visumodel = Darknet(config_path='./news_process/img_detect/model/yolov3.cfg')
        self.visumodel.load_weights('./news_process/img_detect/saved_models/yolov3.weights')
        ## Text model
        if self.lstm:
